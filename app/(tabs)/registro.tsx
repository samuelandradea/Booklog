...
export default function RegistroLeitura() {
  ...
  const handleSalvar = async () => {
    ...
    const novoLivro = { nomeLivro, nomeAutor, nota, resenha };
    try {
    ...
    <SafeAreaView style={styles.safeArea} edges={['top', 'bottom']}>
      <ScrollView style={styles.container} contentContainerStyle={styles.content}>
        ...
        <View style={styles.capaContainer}>
          ...
          <Input style={styles.nomeLivro} value={nomeLivro} onChangeText={setNomeLivro} placeholder="Nome do livro" textAlign="center" />
          <Input style={styles.nomeAutor} value={nomeAutor} onChangeText={setNomeAutor} placeholder="Autor" textAlign="center" />
        </View>
        ...
        <View style={styles.section}>
          ...
          <Input style={styles.resenhaInput} multiline value={resenha} onChangeText={setResenha} placeholder="Escreva sua resenha..." />
        </View>
